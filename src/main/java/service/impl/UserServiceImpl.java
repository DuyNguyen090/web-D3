...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void edit(User newUser, String path) {
        ...
        if (newUser.getAvatar() != null) {
            File oldfile = new File(path + "Images/" + userDao.get(oldUser.getId()).getAvatar());
            if (oldfile.exists()) {
                oldfile.delete();
            }
    ...
    public void delete(int id, String path) {
        ...
        if (userDao.get(id) == null) {
            File oldfile = new File(path + "Images/" + user.getAvatar());
            if (oldfile.exists()) {
                oldfile.delete();
            }
        }
