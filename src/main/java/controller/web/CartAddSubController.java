...
@WebServlet(urlPatterns = {"/cart/add-sub"}) // ?pId=123
public class CartAddSubController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (obj == null) {
            ...
            map.put(existedCartItem.getProduct().getId(), existedCartItem);
            httpSession.setAttribute("cart", map);
        }
        /*
