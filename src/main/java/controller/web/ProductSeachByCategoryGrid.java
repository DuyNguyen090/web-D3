...
@WebServlet(urlPatterns = "/product/category-grid")
public class ProductSeachByCategoryGrid extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/views/web/productSeachByCategoryGrid.jsp").forward(req, resp);
