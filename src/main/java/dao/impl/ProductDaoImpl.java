...
public class ProductDaoImpl extends DBConnection implements ProductDao {
    ...
    public List<Product> seachByCategorySex(String sex) {
        List<Product> productList = new ArrayList<Product>();
        String sql = "SELECT product.id, product.name AS p_name, product.price, product.image, product.des , category.cate_name AS c_name, category.cate_id AS c_id 				"
                + " FROM Product , Category   where Product.cate_id = Category.cate_id and  Category.sex = ?";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public List<Product> seachByCategoryName(String cate_name) {
        List<Product> productList = new ArrayList<Product>();
        String sql = "SELECT product.id, product.name AS p_name, product.price, product.image, product.des , category.cate_name AS c_name, category.cate_id AS c_id 				"
                + " FROM Product , Category   where Product.cate_id = Category.cate_id and  Category.cate_name like ?";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
