                                    ...
                                    <div class="table-responsive">
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td> 
                                                            <a href="<c:url value='/table/details?id=${order.id }'/>" target="iframe">
                                                                <button onclick="document.getElementById('id01').style.display = 'block'" style="width:auto;" title="Chi tiết hóa đơn"> <span class="glyphicon glyphicon-list-alt"></span></button>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="<c:url value='/admin/order/delete?id=${order.id }'/>"class="center">
                                        ...
                                        <div style="text-align: center" class="row">
                                            ...
                                            <c:forEach var="np" begin="1" end="${num_page}">
                                                <li ><a href="<c:url value='/admin/order/list'/>?page=${np}">${np}</a></li>
                                                </c:forEach>
                                        </ul>
                                    </div>
                                </div>
