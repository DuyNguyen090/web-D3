<%-- 
    Document   : slider
    Created on : Jun 10, 2020, 9:59:22 AM
    Author     : DUY
--%>
    ...
    <div class="tp-banner">
        <ul>
            ...
            <li class="revolution-mch-1" data-transition="fade"
                ...
                <!-- MAIN IMAGE --> <img src="<c:url value='/template/web/img/banner1.jpg'/>" alt="darkblurbg"
                ...
                <div class="tp-caption sft" data-x="center" data-hoffset="0"
                     ...
                     style="z-index: 6">
                    <a href="<c:url value='/product/list'/>" class="btn-u btn-brd btn-brd-hover btn-u-light">Shop
                        Now</a>
                </div>
            </li>
            <!-- END SLIDE -->
            ...
            <li class="revolution-mch-1" data-transition="fade"
                ...
                <!-- MAIN IMAGE --> <img src="<c:url value='/template/web/img/banner5.jpg'/>" alt="darkblurbg"
                                         data-bgfit="cover" data-bgposition="left top"
                                         data-bgrepeat="no-repeat">
            ...
            <li class="revolution-mch-1" data-transition="fade"
                ...
                <!-- MAIN IMAGE --> <img src="<c:url value='/template/web/img/banner3.jpg'/>" alt="darkblurbg"
                ...
                <div class="tp-caption revolution-ch3 sft start" data-x="right"
                     ...
                     data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
                     data-endspeed="300">
                    <strong>Bleu De Chanel</strong> Perfume
                </div> <!-- LAYER -->
            ...
            <li class="revolution-mch-1" data-transition="fade"
                ...
                <!-- MAIN IMAGE --> <img src="<c:url value='/template/web/img/banner2.jpg'/>" alt="darkblurbg"
                                         data-bgfit="cover" data-bgposition="left top"
                                         data-bgrepeat="no-repeat">
            ...
            <li class="revolution-mch-1" data-transition="fade"
                ...
                <!-- MAIN IMAGE --> <img src="<c:url value='/template/web/img/banner4.jpg'/>" alt="darkblurbg"
                                         data-bgfit="cover" data-bgposition="right top"
                                         data-bgrepeat="no-repeat">
                ...
                <div class="tp-caption revolution-ch5 sft start" data-x="right"
                     ...
                     data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
                     data-endspeed="300">
                    <strong>Perfume</strong> Collection
                </div> <!-- LAYER -->
                <div class="tp-caption revolution-ch4 sft" data-x="right"
                     data-hoffset="-14" data-y="210" data-speed="1400"
                     data-start="2000" data-easing="Power4.easeOut"
